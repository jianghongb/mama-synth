...
The diffusion baseline scores poorly here (SSIM 0.029, Dice 0.072, HD95 419.8), for the reasons given in Section~\ref{subsec:experiment_setting}; our global z-score baseline already outperforms it on every metric.
