...
#
# v22_vgg20: v22 on data_multislice_v3 with lambda_vgg=20 (2x default).
# Target: lower LPIPS by stronger perceptual supervision.
# Also reduced lambda_mssc 50→30 to rebalance loss.
...
echo "Done! Weights: $PROJ/checkpoints/mamasynth_v22_vgg20/latest_net_G.pth"
