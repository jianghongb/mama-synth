...
#
# v29b: Swin Transformer bottleneck on data_multislice_v2 (Dataset930 breast mask)
# Same as v29 but on new dataset (center slices only, cleaner data)
...
echo "=== Starting v29b training (Swin bottleneck, data_multislice_v2) ==="
...
echo "Done! Weights: $PROJ/checkpoints/mamasynth_v29b/latest_net_G.pth"
