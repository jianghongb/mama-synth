...
#
# v31_auroc: v31_pinorm targeting higher AUROC contrast.
# Changes vs v31_pinorm:
#   - tumor_weight: 10 → 20 (force stronger tumor enhancement)
#   - lambda_mssc: 50 → 100 (stronger subtraction consistency)
#   - no GT clip (preserve tumor signal — clip caused AUROC=0.55 in v31b)
# Data: data_multislice_v3 (peak GT, consistent enhancement)
...
echo "Done! Weights: $PROJ/checkpoints/mamasynth_v31_auroc/latest_net_G.pth"
