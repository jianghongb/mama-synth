...
#
# v26 on data_multislice_v3: wider network (ngf=96, n_blocks=12).
# Peak ± 2 slices, global peak GT, + LAB data, ~7042 samples.
# noise_aug + intensity_aug + breast mask.
...
echo "Done! Weights: $PROJ/checkpoints/mamasynth_v26_v3/latest_net_G.pth"
