...
#
# v25: v20 + uncertainty-aware heteroscedastic loss (inspired by SAFE-Diff).
# Generator outputs (mu, log_var). Loss adaptively reweights per-pixel error
# based on predicted confidence. Spatial weights: bg=1, breast=20, tumor=1000.
...
echo "=== Starting v25 training (uncertainty-aware) ==="
...
echo "Done! Weights: $PROJ/checkpoints/mamasynth_v25/latest_net_G.pth"
