...
#
# v28b: UC-GAN uncertainty on data_multislice_v2 (Dataset930 breast mask)
# Same as v28 but on new dataset (center slices only, cleaner data)
...
echo "Done! Weights: $PROJ/checkpoints/mamasynth_v28b/latest_net_G.pth"
