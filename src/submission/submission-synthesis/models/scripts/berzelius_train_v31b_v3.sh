...
#
# v31b_v3: pinorm + Huber + GT clip on data_multislice_v3 (9504 samples, AMBL included).
# New checkpoint name to preserve v31b (trained before AMBL split).
...
echo "=== Starting v31b_v3 (pinorm + huber + GT clip, AMBL included) ==="
