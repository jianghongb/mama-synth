...
#
# v31_msv2: Per-Image Z-Score Normalization on data_multislice_v2.
# Same as v31_pinorm but trained on v2 data (~8.9k samples, more data).
# Test: does more training data + pinorm further improve results?
...
echo "=== Starting v31_msv2 (per-image z-score on data_multislice_v2) ==="
cd $PROJ/mama-synth/src/submission/submission-synthesis/models

python train.py \
  --name mamasynth_v31_msv2 \
  --model pix2pixHD \
...
echo "Done! Weights: $PROJ/checkpoints/mamasynth_v31_msv2/latest_net_G.pth"
