...
#
# v31b_v2: pinorm + Huber loss + GT clipping on data_multislice_v2 (~11893 samples).
# More data (per-phase GT) + robust loss. Compare with v31b on v3 (~9504 samples).
...
echo "=== Starting v31b_v2 (pinorm + huber + GT clip on v2 data) ==="
