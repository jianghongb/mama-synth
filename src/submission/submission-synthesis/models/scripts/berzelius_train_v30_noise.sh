...
#
# v30: v22 config (n_blocks=12, ngf=64) + data_multislice_v2 + noise_aug.
# Same architecture as v22 but trained on per-phase peak slices (~5k samples)
# with Gaussian noise augmentation on input (σ=0.02-0.05) and GT (σ=0.02-0.08).
