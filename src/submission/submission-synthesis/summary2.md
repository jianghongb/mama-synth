...
4. **v5→v8**: 加 intensity_aug — 全面提升，尤其 HD95 (55.6→37.7)

### 4. 训练版本对比 (data_split_v2/test, 150 cases)

| Metric | v5 | v6 | v7 | **v8 (best)** | GC #1 |
|--------|:-:|:-:|:-:|:-:|:-:|
| MSE ↓ | 0.28 | 0.87 | 0.89 | **0.26** | 0.81 |
| LPIPS ↓ | 0.074 | 0.114 | 0.138 | **0.071** | 0.098 |
| SSIM_tumor ↑ | 0.701 | 0.423 | 0.407 | **0.718** | 0.501 |
| FRD ↓ | 10.41 | 12.78 | — | **9.77** | 23.10 |
| AUROC contrast | 0.930 | 0.926 | — | **0.929** | 0.813 |
| Dice ↑ | 0.684 | 0.492 | 0.437 | **0.708** | 0.487 |
| HD95 ↓ | 55.6 | 105.8 | — | **37.7** | 107.4 |

**跨域验证 (yunnan, 100 cases)**
...
| **v8** | v5 + intensity_aug (scale+bias) | 1074 | **0.26** | **0.071** | **0.718** | **0.708** | ✅ 当前最佳 |
