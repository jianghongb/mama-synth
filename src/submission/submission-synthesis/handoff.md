...
| Metric | v5 | v6 | v7 | **v8** |
|--------|:-:|:-:|:-:|:-:|
| MSE ↓ | 0.393 | 0.399 | **0.125** | **0.009** |
| LPIPS ↓ | 0.235 | 0.290 | 0.120 | **0.045** |
| SSIM_tumor ↑ | 0.405 | 0.324 | 0.482 | **0.759** |
| FRD ↓ | 29.55 | 30.45 | 28.56 | **25.52** |
| AUROC ↑ | 0.879 | **0.934** | 0.844 | 0.740 |
| Dice ↑ | 0.095 | 0.076 | 0.090 | **0.373** |
| HD95 ↓ | 574.7 | 584.6 | 651.2 | **235.8** |

**结论**: v8 在外部数据上 image fidelity (MSE/LPIPS/SSIM) 全面最佳。Dice/HD95 受限于评估分割模型未见过 yunnan 数据。
