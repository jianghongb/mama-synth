...
#SBATCH -o /proj/berzbiomedicalimagingkth/users/x_honji/distill_extract_%j.log
#SBATCH -e /proj/berzbiomedicalimagingkth/users/x_honji/distill_extract_%j.err
#
# Extract 2D slices from 3D predictions → nnUNet format
...
print(f'Done: {count} 2D slices extracted.')
"
